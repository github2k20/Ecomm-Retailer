...
class _CompletedOrdersState extends State<CompletedOrders> {
  ...
  Widget build(BuildContext context) {
    completedOrders=orders.getCompletedOrders(context);
...
//
                  ...
                  Padding(
                    ...
                    child: IconButton(icon: Icon(Icons.check_circle,color: product['completed']?Colors.green: Colors.orange,size: 40,),
                      onPressed: () {
                      },
                    ),
                  ),
